...
import {
  ...
  getFullnodeUrl,
  isSuiClient
} from "./chunk-POEMSHTS.js";
import "./chunk-TBJNJ4DP.js";
import {
  Transaction
} from "./chunk-M7HLB4OD.js";
import {
  formatAddress
} from "./chunk-Z6NQ4XBV.js";
import {
  array,
  boolean,
  lazy,
...
var _0n = BigInt(0);
var _1n = BigInt(1);
function _abool2(value, title3 = "") {
  if (typeof value !== "boolean") {
    const prefix = title3 && `"${title3}"`;
    throw new Error(prefix + "expected boolean, got type=" + typeof value);
  }
  return value;
}
function _abytes2(value, length, title3 = "") {
...
function aInRange(title3, n, min, max) {
  if (!inRange(n, min, max))
    throw new Error("expected valid " + title3 + ": " + min + " <= n < " + max + ", got " + n);
}
function bitLen(n) {
  let len;
...
// node_modules/@mysten/sui/node_modules/@noble/curves/esm/abstract/hash-to-curve.js
...
// node_modules/@mysten/sui/node_modules/@noble/curves/esm/abstract/montgomery.js
var _0n5 = BigInt(0);
var _1n5 = BigInt(1);
var _2n3 = BigInt(2);
...
// node_modules/@mysten/sui/node_modules/@noble/curves/esm/abstract/weierstrass.js
...
function weierstrassN(params, extraOpts = {}) {
  ...
  function acoord(title3, n, banZero = false) {
    if (!Fp2.isValid(n) || banZero && Fp2.is0(n))
      throw new Error(`bad point coordinate ${title3}`);
    return n;
  }
...
function ecdsa(Point, hash, ecdsaOpts = {}) {
  ...
  function validateRS(title3, num) {
    if (!Fn2.isValidNot0(num))
      throw new Error(`invalid signature ${title3}: out of range 1..Point.Fn.ORDER`);
    return num;
  }
...
// node_modules/@mysten/sui/node_modules/@noble/curves/esm/_shortw_utils.js
function createCurve(curveDef, defHash) {
  const create = (hash) => weierstrass({ ...curveDef, hash });
  return { ...create(defHash), create };
}

// node_modules/@mysten/sui/node_modules/@noble/curves/esm/nist.js
var p256_CURVE = {
...
// node_modules/@mysten/sui/node_modules/@noble/curves/esm/p256.js
var secp256r1 = p256;
